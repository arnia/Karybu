 ...
 *
 * Please note that in order to use this class, you must have a vaild {@link http://xpressengine.com/api-keys/ WordPress API key}.  They are free for non/small-profit types and getting one will only take a couple of minutes.
 *
...
class Akismet {
    ...
    public function isCommentSpam() {
        ...
        if($response[1] == 'invalid' && !$this->isKeyValid()) {
            throw new exception('The XpressEngine API key passed to the Akismet constructor is invalid.  Please obtain a valid one from http://xpressengine.com/api-keys/');
        }
