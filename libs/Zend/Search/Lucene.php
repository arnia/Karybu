...
require_once 'Lucene/Document/Html.php';

/** Zend_Search_Lucene_Document_Docx */
require_once 'Lucene/Document/Docx.php';

/** Zend_Search_Lucene_Document_Pptx */
require_once 'Lucene/Document/Pptx.php';

/** Zend_Search_Lucene_Document_Xlsx */
require_once 'Lucene/Document/Xlsx.php';
...
require_once 'Lucene/Analysis/Analyzer.php';

/** Zend_Search_Lucene_Search_Query_Term */
require_once 'Lucene/Search/Query/Term.php';

/** Zend_Search_Lucene_Search_Query_Phrase */
require_once 'Lucene/Search/Query/Phrase.php';

/** Zend_Search_Lucene_Search_Query_MultiTerm */
require_once 'Lucene/Search/Query/MultiTerm.php';

/** Zend_Search_Lucene_Search_Query_Wildcard */
require_once 'Lucene/Search/Query/Wildcard.php';

/** Zend_Search_Lucene_Search_Query_Range */
require_once 'Lucene/Search/Query/Range.php';

/** Zend_Search_Lucene_Search_Query_Fuzzy */
require_once 'Lucene/Search/Query/Fuzzy.php';

/** Zend_Search_Lucene_Search_Query_Boolean */
require_once 'Lucene/Search/Query/Boolean.php';

/** Zend_Search_Lucene_Search_Query_Empty */
require_once 'Lucene/Search/Query/Empty.php';

/** Zend_Search_Lucene_Search_Query_Insignificant */
require_once 'Lucene/Search/Query/Insignificant.php';
...
require_once 'Lucene/Interface.php';

/** Zend_Search_Lucene_Index_SegmentInfo */
require_once 'Lucene/Index/SegmentInfo.php';

/** Zend_Search_Lucene_LockManager */
require_once 'Lucene/LockManager.php';
...
class Zend_Search_Lucene implements Zend_Search_Lucene_Interface
{
    ...
    public function terms()
    {
        ...
        require_once 'Lucene/Index/TermsPriorityQueue.php';
    ...
    public function resetTermsStream()
    {
        if ($this->_termsStream === null) {
            ...
            require_once 'Lucene/TermStreamsPriorityQueue.php';
