...
require_once XE_LUCENE_PATH . '/LockManager.php';
...
class Zend_Search_Lucene_Index_Writer
{
    ...
    public function addDocument(Zend_Search_Lucene_Document $document)
    {
        ...
        require_once XE_LUCENE_PATH . '/Index/SegmentWriter/DocumentWriter.php';
    ...
    private function _mergeSegments($segments)
    {
        ...
        require_once XE_LUCENE_PATH . '/Index/SegmentMerger.php';
            ...
            for ($count = 0; $count < $segmentsCount; $count++) {
                ...
                if (!in_array($segName, $this->_segmentsToDelete)) {
                    ...
                    if (!isset($this->_segmentInfos[$segName])) {
                        ...
                        require_once XE_LUCENE_PATH . '/Index/SegmentInfo.php';
