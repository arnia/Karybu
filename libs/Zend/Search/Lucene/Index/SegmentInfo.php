...
require_once XE_LUCENE_PATH . '/Index/TermsStream/Interface.php';


/** Zend_Search_Lucene_Search_Similarity */
require_once XE_LUCENE_PATH . '/Search/Similarity.php';

/** Zend_Search_Lucene_Index_FieldInfo */
require_once XE_LUCENE_PATH . '/Index/FieldInfo.php';

/** Zend_Search_Lucene_Index_Term */
require_once XE_LUCENE_PATH . '/Index/Term.php';

/** Zend_Search_Lucene_Index_TermInfo */
require_once XE_LUCENE_PATH . '/Index/TermInfo.php';
...
class Zend_Search_Lucene_Index_SegmentInfo implements Zend_Search_Lucene_Index_TermsStream_Interface
{
    ...
    private function _loadDictionaryIndex()
    {
        ...
        require_once XE_LUCENE_PATH . '/Index/DictionaryLoader.php';
