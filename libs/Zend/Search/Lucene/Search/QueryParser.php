...
require_once XE_LUCENE_PATH . '/Search/QueryToken.php';



/** Zend_Search_Lucene_FSM */
require_once XE_LUCENE_PATH . '/FSM.php';
...
class Zend_Search_Lucene_Search_QueryParser extends Zend_Search_Lucene_FSM
{
    ...
    public function __construct()
    {
        ...
        require_once XE_LUCENE_PATH . '/Search/QueryLexer.php';
    ...
    public static function parse($strQuery, $encoding = null)
    {
        ...
        require_once XE_LUCENE_PATH . '/Search/QueryParserException.php';
        try {
            require_once XE_LUCENE_PATH . '/Search/QueryParserContext.php';
            ...
            foreach (self::$_instance->_tokens as $token) {
                try {
                    ...
                    require_once XE_LUCENE_PATH . '/Exception.php';
    ...
    {
        require_once XE_LUCENE_PATH . '/Search/QueryEntry/Term.php';
    ...
    {
        require_once XE_LUCENE_PATH . '/Search/QueryEntry/Phrase.php';
    ...
    public function subqueryEnd()
    {
        ...
        require_once XE_LUCENE_PATH . '/Search/QueryEntry/Subquery.php';
    ...
    public function openedRQLastTerm()
    {
        ...
        require_once XE_LUCENE_PATH . '/Search/Query/Range.php';
