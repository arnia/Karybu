...
class Zend_Search_Lucene_Search_QueryParserContext
{
    ...
    {
        require_once XE_LUCENE_PATH . '/Search/Query/Boolean.php';
        $query = new Zend_Search_Lucene_Search_Query_Boolean();

        require_once XE_LUCENE_PATH . '/Search/QueryParser.php';
    ...
    private function _booleanExpressionQuery()
    {
        ...
        require_once XE_LUCENE_PATH . '/Search/BooleanExpressionRecognizer.php';
