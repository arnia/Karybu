...
function completeGetFtpInfo(ret_obj)
{
    ...
    if(pwd != "/")
    {
        ...
        arr.push("");
        target = arr.join("/");
        list = list + "<li><a href='#ftpSetup' class='ftp-list-item' onclick=\"getFTPList('"+target+"')\">../</a></li>";
    }
    ...
    {   
        ...
        {
            list = list + "<li><a href='#ftpSetup' class='ftp-list-item' onclick=\"getFTPList('"+pwd+v+"')\">"+v+"</a></li>";
        }
    }
